...
Public Class frmCstmCtrl
    ...
    Private Sub frmHWCoil_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Call PopulateAuxPanelList() 'V1.1

        'Set up the famcase presets
    ...
    Private Sub TagALongPopulate(loccode As String)
        ...
        If Reccount > 0 Then
            MySQL2 = "SELECT tblCstmCtrl.CstmCode as CstmCode, tblCstmCtrl.CstmFIOP as CstmFIOP, tblCstmTagALong.TagALongData as TagALongID, tblCstmTagALong.DataComment as TagAlongName FROM tblCstmCtrl INNER JOIN tblCstmTagALong ON tblCstmCtrl.CstmCode = tblCstmTagALong.CstmCode WHERE (((tblCstmCtrl.CstmFIOP)='" & loccode & "'))"
