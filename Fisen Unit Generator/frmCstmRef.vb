Public Class frmCstmRef
    ...
    Private Sub TagALongPopulate(loccode As String)
        ...
        MySQL2 = "SELECT * FROM tblCstmRef WHERE CstmFIOP='" & loccode & "'"
    ...
    Private Sub FIOPPreview()
        ...
        'Update next line
        MySQL = "SELECT * FROM tblFisenInstalledOptions WHERE FIOpCode Like '970%'"
        rs.Open(MySQL, con)

        'Update next line
        TempModList.Add("970000")
    ...
    Private Sub cmdScience_Click(sender As Object, e As EventArgs) Handles cmdScience.Click
        Dim dummy As MsgBoxResult
        dummy = MsgBox("Science! for the Custom Refrigeration Module is not yet implemented.")
        WriteToEventLog("CstmRef", "Science! for the Custom Refrigeration Module is not yet implemented.", "Development", Str(dummy))
    End Sub
End Class